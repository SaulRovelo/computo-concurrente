...
#define TAMANIO 10 // Definimos el tamaño del arreglo

int arreglo[TAMANIO]; // Declaración de un arreglo global de tamaño 10
...
int main(int argc, char* argv[]){
    ...
    // Inicializa el arreglo con valores del 0 al TAMANIO-1
...
//Este programa simula el procesamiento de un arreglo de tamaño 10, dividiéndolo en dos partes 
